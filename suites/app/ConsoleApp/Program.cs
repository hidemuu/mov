...
internal class Program
{
    ...
    private static string Execute(IEnumerable<string> parameters)
    {
        ...
        var timeTrends = Task.WhenAll(_regionAnalizerClient.GetTrendLineAsync(new RegionRequest(new List<int>() { 11362 }, new List<int>() { 11 }, "population", "all").CreateSchema(), TimeValue.Empty, TimeValue.Empty)).Result[0];
        return string.Empty;
    }
