...
namespace Mov.Api.Controllers
{
    ...
    [ApiController]
    public class DesignerContentController : ControllerBase
    {
        #region field
        ...
        public DesignerContentController(IDesignerRepository repository)
        {
        ...
        {
            return await this.repository.Contents.GetsAsync();
        }
