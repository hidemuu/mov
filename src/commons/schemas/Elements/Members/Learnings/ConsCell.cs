...
namespace Mov.Schemas.Elements.Members.Learnings
{
    /// <summary>
    /// Nilクラス（空リストを表す）
    /// </summary>
    ...
    public class ConsCell : IComparable<ConsCell>
    {
        ...
        {
            if (n == 0) return ConsCell.Nil;
            else return new ConsCell(x, ConsCell.Fill(x, n - 1));
        }
        ...
        {
            return ConsCell.FromArray(s.Split(delim));
        }
        ...
        {
            var pos = FindPos(fun);
            return ConsCell.Of(SplitLeft(pos), SplitRight(pos + 1));
        }
        ...
        {
            Console.WriteLine("Cons.Nil.Equals(Cons.Nil)\t= " + ConsCell.Nil.Equals(ConsCell.Nil));
            Console.WriteLine("new Cons().Equals(new Cons())\t= " + new ConsCell().Equals(new ConsCell()));
            Console.WriteLine("new Cons().Equals(Cons.Nil)\t= " + new ConsCell().Equals(ConsCell.Nil));
            Console.WriteLine("Cons.Nil.Equals(new Cons())\t= " + ConsCell.Nil.Equals(new ConsCell()));

            var a = ConsCell.Of(1, 2, 3);
            var b = ConsCell.Of(2, 2, "3");
            var c = ConsCell.Of(ConsCell.Of(1, 2, 3), ConsCell.Of(4, 5), ConsCell.Of(6));
            ...
            Console.WriteLine("Cons.Of(1, 2, 3)\t= " + ConsCell.Of(1, 2, 3));
            Console.WriteLine("Cons.Range(1, 5)\t= " + ConsCell.Range(1, 5));

            var e = new int[] { 1, 2, 3 };
            var d = new List<int>() { 1, 2, 3 };
            Console.WriteLine("Cons.FromArray(e)\t= " + ConsCell.FromArray(e));
            Console.WriteLine("Cons.FromList(d)\t= " + ConsCell.FromList(d));
