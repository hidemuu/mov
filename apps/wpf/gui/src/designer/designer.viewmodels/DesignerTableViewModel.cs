...
namespace Mov.Designer.ViewModels
{
    public class DesignerTableViewModel : DragDropViewModelBase
    {
        ...
        private void Post()
        {
            var tables = new List<ContentSchema>();
        ...
        private void ConvertModelToContent(ICollection<ContentSchema> items, IEnumerable<DesignerTableModel> models)
        {
    ...
    public class DesignerTableModel
    {
        ...
        public DesignerTableModel(ContentSchema item)
        {
            Update(item);
        }
        ...
        protected virtual void Update(ContentSchema item)
        {
            if (item == null) return;
            Id.Value = item.Id;
