...
namespace Mov.Driver.Service.CNC.Fanuc
{
    ...
    public class ODBAXISNAME
    {
        ...
        /*-----------------------------------------------*/
        #region 構造：データサーバ / Ethernetボード機能
        ...
        /* CNC: Control axis / spindle related */
        /*-------------------------------------*/
        #region DLL：軸制御(スピンドル含む)
        /// <summary>
        /// ロジックDLLインポート：軸制御
        /// read actual axis feedrate(F)
        /// </summary>
        /// <param name="FlibHndl">ライブラリハンドル</param>
        /// <param name="a"></param>
        /// <returns></returns>
    ...
    public static extern short cnc_rddynamic(ushort FlibHndl,
        ...
        /// </summary>
        /// <param name="FlibHndl">ライブラリハンドル</param>
        /// <param name="a">取得結果構造インスタンス</param>
...
#if (!ONO8D)
        /// <summary>
        /// ロジックDLLインポート：指定NCプログラム削除
        /// delete specified program
        /// </summary>
        /// <param name="FlibHndl">ライブラリハンドル</param>
        /// <param name="a">削除プログラム番号</param>
        /// <returns>Focasレスポンス</returns>
    ...
    public static extern short cnc_rdmdipntr( ushort FlibHndl, [Out,MarshalAs(UnmanagedType.LPStruct)] ODBMDIP a );
...
#endif
        /// <summary>
        /// ロジックDLLインポート：パラメータ書込
        /// write parameter
        /// </summary>
        /// <param name="FlibHndl">ライブラリハンドル</param>
        /// <param name="length">データブロック長</param>
        ...
        /// <summary>
        /// ロジックDLLインポート：CNCステータス読出
        /// read CNC status information
        /// </summary>
        /// <param name="FlibHndl">ライブラリハンドル</param>
        /// <param name="a">対象構造クラス</param>
        /// <returns>Focasレスポンス</returns>
    ...
    public static extern short cnc_rdprogdir2( ushort FlibHndl,
        ...
        /* DS : Data server & Ethernet board function    */
        /*-----------------------------------------------*/
        #region DLL：データサーバ / Ehternetボード機能
        ...
        /* Ethernet connection */
        /*---------------------*/
        #region DLL：Ethernetコネクション
        /// <summary>
        /// ロジックDLLインポート：ライブラリハンドル設定
